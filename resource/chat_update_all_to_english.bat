...
ECHO ====================================================================================================%ESC%[0m
copy "chat_english.txt" "chat_arabic.txt"
...
copy "chat_english.txt" "chat_hebrew.txt"
...
copy "chat_english.txt" "chat_latvian.txt"
copy "chat_english.txt" "chat_lithuanian.txt"
...
copy "chat_english.txt" "chat_slovak.txt"
