"Resource/UI/MainMenuOverride.res"
{
    ...
    // Icons that can't be preloaded
    // Backpack Icons (viewmode_ files)
    // TargetID dead icon (health_dead)
    // Halloween Spell Icons (spellbook_<spell>)

    // Player Destruction / Robot Destruction
    "objectives_flagpanel_compass_blue" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_corepanel_bg" }

    // CTF - Base
    "objectives_flagpanel_compass_blue" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_flagpanel_compass_blue" }
    "objectives_flagpanel_compass_blue_noarrow" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_flagpanel_compass_blue_noarrow" }
    "objectives_flagpanel_compass_grey" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_flagpanel_compass_grey" }
    "objectives_flagpanel_compass_red" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_flagpanel_compass_red" }
    "objectives_flagpanel_compass_red_noarrow" { "ControlName" "ImagePanel" "ypos" "r-6969" "visible" "0" "enabled" "0" "image" "../hud/objectives_flagpanel_compass_red_noarrow" }
